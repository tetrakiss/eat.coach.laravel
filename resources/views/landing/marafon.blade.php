...
<div class="uk-flex-center uk-text-center neoBg" uk-grid>
    ...
    <div class="uk-card uk-card-default">
               ...
               <div class="uk-card-body">
                   <h3 class="uk-card-title">РЕБЕНОК НЕ ЖУЁТ. ЧТО ДЕЛАТЬ?</h3>
                   <p class="uk-text-left">⠀
                     С 11 по 17 мая 2020 года<br>
                     Онлайн формат<br>
                     8 экспертов<br>
                     Каждый день в 18:00 по Москве<br>
                     Прямой эфир с одним из экспертов, во время которого мы обсудим:<br>
                     Что делать, если Ваш ребенок не умеет жевать?<br>
                     Эксперты из разных областей:<br>
                     Гастроэнтеролог<br>
                     Ортодонт<br>
                     Нейрологопед<br>
                     Специалист ранней помощи<br>
                     Специалист по методу Костильо Моралес<br>
                     АВА-терапист<br>
                     Специалист сенсорной интеграции<br>
                     Специалист по коррекции пищевого поведения<br>
                     Где: <a href="https://www.instagram.com/eat.coach/">@eat.coach</a>
</p>
    ...
    <div class="uk-card uk-card-default">
               ...
               <div class="uk-card-body">
                   <h3 class="uk-card-title">Оксана Жигалова</h3>
                   <p class="uk-text-left">⠀
⚕️Врач терапевт, клиническая интернатура по гастроэнтерологии.<br>
⠀
...
✅Нутрициология<br>
⠀
✅Врач Диетолог-нутрициолог<br>
⠀
✅ Восстановительная медицина<br>
⠀
✅Врач восстановительной медицины<br>
⠀
✅Микроэлеметология<br>
</p>
...
<p><iframe style="height:480px;" class="uk-responsive-width" width="853" height="480" src="https://www.youtube.com/embed/WLloIUEvu5k?showinfo=0&rel=0&cc_load_policy=1&iv_load_policy=3&theme=light" frameborder="0" allowfullscreen></iframe></p>
    ...
    <div class="uk-card uk-card-default">
               ...
               <div class="uk-card-body">
                   <h3 class="uk-card-title">Людмила Тихонова</h3>
                   <p class="uk-text-left">⠀
                     ...
                     ⠀
                     ✅Психокоррекция, глубинная психология и психоанализ<br>
                     ⠀
                     ✅Семейная психотерапия<br>
                     ⠀
                     ✅Альтернативная коммуникация PECS ( курс L.Frost, A. Bondy)<br>
                     ⠀
                     ✅Сенсорная Интеграция<br>
                     ⠀
                     💚Курс Уллы Кислинг<br>
                     ⠀
                     💚Курс Агнешки Лемански<br>
                     ⠀
                     💚Курс Daniela Schlager-Jaschky<br>
                     ⠀
                     💚Курс А. Лопиколло<br>
...
<p><iframe style="height:480px;" class="uk-responsive-width" width="853" height="480" src="https://www.youtube.com/embed/7koPl7zfZQM?showinfo=0&rel=0&cc_load_policy=1&iv_load_policy=3&theme=light" frameborder="0" allowfullscreen></iframe></p>
    ...
    <div class="uk-card uk-card-default">
               ...
               <div class="uk-card-body">
                   <h3 class="uk-card-title">Наталья Ершихина</h3>
                   <p class="uk-text-left">⠀

                     ⠀

   ⠀
   👩‍🏫Педагог-дефектолог<br>
   ⠀
   ✅Логопед<br>
   ⠀
   ✅Специалист ранней помощи<br>
   ⠀
   ✅Специалист по АДК ( альтернативной и дополнительной коммуникации)<br>
   ⠀
   ✅Специалист центра Дети Ангелы в Дзержинске Нижегородская область<br>
   ⠀
   👩‍👦‍👦Мама мальчика с детским церебральным параличом<br>
   ⠀
   ❗❗❗Опыт работы с детьми с особенностями в развитии - 6 лет ❗❗❗<br>
   ⠀
    ...
    <div class="uk-card uk-card-default">
               ...
               <div class="uk-card-body">
                   <h3 class="uk-card-title">Волкова Анна</h3>
                   <p class="uk-text-left">⠀

   ⠀
   👩‍⚕️Стоматолог-ортодонт<br>
   ⠀
   ...
   Дополнительное образование:<br>
   ⠀
   ✅Более 50 семинаров у отечественных и иностранных лекторов по основной и смежным специальностям в стоматологии<br>
   ⠀
