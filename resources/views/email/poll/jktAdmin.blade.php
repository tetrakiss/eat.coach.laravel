                        ...
                        <tbody>
                          <tr>
                            <td align="center" style="font-size:0px;padding:0px 25px 0px 25px;word-break:break-word;">
                              <div style="font-family:Arial, sans-serif;font-size:25px;line-height:38px;text-align:center;color:#55575d;"> Ваш Индекс тяжести ЖКТ </div>
                            </td>
                          </tr>
                          <tr>
                            <td align="center" style="font-size:0px;padding:0px 25px 0px 25px;word-break:break-word;">
                          ...
                          <tr>
                            <td align="center" style="font-size:0px;padding:0px 25px 0px 25px;word-break:break-word;">
                              <div style="font-family:Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#222222;">Индекс ЖКТ сотавил:</div>
                              <div style="font-family:Arial, sans-serif;font-size:14px;line-height:18px;text-align:left;color:#55575d;">{{$total}}</div>
                            </td>
                          </tr>
                          <tr>
                            <td align="center" style="font-size:0px;padding:0px 25px 0px 25px;word-break:break-word;">
                              <div style="font-family:Arial, sans-serif;font-size:18px;line-height:48px;text-align:center;;color:#222222;"><a style="color:#c84033; text-decoration:none;"href="{{ url('sign_up') }}">Записаться на консультацию</a></div>
